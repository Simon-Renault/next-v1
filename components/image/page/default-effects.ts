...
interface IEffectOutput {
	style: React.CSSProperties;
}

function cubeEffect(info: PageEffectInfo): IEffectOutput {
...
function coverflowEffect(info: PageEffectInfo): IEffectOutput {
	const { normalizedOffset, direction } = info;
	const isHorizontal = direction === 'horizontal';
...
function pileEffect(info: PageEffectInfo): IEffectOutput {
...
function wheelEffect(info: PageEffectInfo): IEffectOutput {
